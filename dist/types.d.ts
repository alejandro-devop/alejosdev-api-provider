...
export type HookReturnType = [
    (((p?: any, configOverride?: ApiConfigType) => Promise<any>) | ((p?: any, configOverride?: ApiConfigType) => Promise<any>)),
    boolean
];
/**
 * Type for the return of the hooks like usePost, usePut, usePatch which handles payloads
 */
export type HookReturnWithPayloadType<PayloadType> = [
    (((payload: PayloadType) => any) | ((payload: PayloadType, configOverride?: ApiConfigType) => Promise<any>)),
    boolean,
    {
        errors?: string[];
    }
